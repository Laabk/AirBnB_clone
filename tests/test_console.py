#!/usr/bin/python3
"""the case module for testing HBNBCommand class."""
...
class TestHBNBCommand(unittest.TestCase):
    ...
    """the test case for HBNBCommand console."""
    ...
    def resetStorage(self):
        """the FileStorage data."""
        FileStorage._FileStorage__objects = {}
        if os.path.isfile(FileStorage._FileStorage__file_path):
            os.remove(FileStorage._FileStorage__file_path)

    def test_help(self):
        """testing for the help command."""
        with patch('sys.stdout', new=StringIO()) as f:
            HBNBCommand().onecmd("help")
        s = """
Documented commands (type help <topic>):
========================================
all  EOF  count  create  destroy  help  quit  show  update
...
"""
    ...
    def test_do_show_error(self):
        """
        Testing for tools 'show' command with errors.
        """
        with patch('sys.stdout', new=StringIO()) as f:
    ...
    def help_test_show_advanced(self, classname):
        """testing for 'show' command tools help."""
        with patch('sys.stdout', new=StringIO()) as f:
            HBNBCommand().onecmd("create {}".format(classname))
        uid = f.getvalue()[:-1]
        self.assertTrue(len(uid) > 0)
    ...
    def test_do_destroy(self):
        """Testing for 'destroy' for all classes."""
        for classname in self.classes():
    ...
    def test_do_destroy_error(self):
        """Testing tools for 'destroy' command with errors."""
        with patch('sys.stdout', new=StringIO()) as f:
    ...
    def test_do_destroy_error_advanced(self):
        """Tests tools for destroy command with errors."""
        with patch('sys.stdout', new=StringIO()) as f:
            HBNBCommand().onecmd(".destroy()")
        msg = f.getvalue()[:-1]
        self.assertEqual(msg, "** class name missing **")
    ...
    def test_do_count_error(self):
        """Testing the command for errors."""
        with patch('sys.stdout', new=StringIO()) as f:
    ...
    def test_update_everything(self):
        """testing the update command using the err method"""
    ...
    def help_test_update(self, classname, uid, attr, val, quotes, func):
        """
        Class for testing any update commmand.
        """
        #  print("QUOTES", quotes)
        FileStorage._FileStorage__objects = {}
        if os.path.isfile("file.json"):
    ...
    def classes(self):
        """
        updates a dictionary with valid classes and references.
        """
    ...
    def attributes(self):
        """
        updates a valid attributes with  classname types.
        """
        attributes = {
            "BaseModel":
                     {"id": str,
